      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-[100] mt-2 bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-gray-100 p-4 left-0 right-0 mx-auto w-full max-w-[320px] md:left-0 md:right-auto md:mx-0 md:w-[320px] overflow-hidden"
          >
            ...
            <DayPicker
              ...
              className="rdp-custom mx-auto w-full"
              classNames={{
                ...
                weekdays: "flex mb-2",
                weekday: "text-gray-400 flex-1 min-w-0 font-black text-[10px] uppercase flex items-center justify-center h-8",
                week: "flex w-full mt-1",
                day: "h-10 flex-1 min-w-0 p-0 relative flex items-center justify-center",
                day_button: "h-9 w-9 max-w-full p-0 font-bold aria-selected:opacity-100 hover:bg-blue-50 rounded-xl transition-all flex items-center justify-center text-sm",
            ...
            <div className="mt-4 pt-4 border-t border-gray-50 flex justify-between items-center gap-3">
              ...
              {localRange?.from && localRange?.to && (
                <button 
                  ...
                  className="shrink-0 px-4 py-2 bg-blue-600 text-white rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-blue-700 transition-all"
                >
                  Valider
                </button>
              )}

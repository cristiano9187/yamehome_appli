...
/**
 * Mentions légales émetteur pour factures société :
 * RCCM (Greffe) + NIU DGI — à mettre à jour si votre immatriculation change.
 */
export const COMPANY_LEGAL_ISSUER = {
  legalTradeName: 'ETS WEYAMP',
...
export const TARIFS: TarifMap = {
  ...
  'MATERA YAMEHOME - CHAMBRE STANDARD': {
      ...
      '1-2': { prix: 17000, caution: 5000 }, '3+': { prix: 17000, caution: 10000 }
  },
  'GALLAGHERS CITY - CHAMBRE STANDARD SIMPLE': { 
